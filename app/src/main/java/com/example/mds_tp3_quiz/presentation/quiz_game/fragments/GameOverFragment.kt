...
class GameOverFragment : Fragment() {
    ...
    private fun addListeners() {
        playAgain.setOnClickListener {
            startActivity(Intent(this@GameOverFragment.requireContext(), NavigationActivity::class.java))
        }
    }
    ...
    private fun setupScores(){
        ...
        pointsEarned.text = String.format(getString(R.string.points_earned), (activity as QuizGameActivity).getScore() * 10)
    }
